...
import { attendanceStatus, formatDateTime } from '../../shared/utils/format';
                  ...
                  {attendance.data.data.map((record) => (
                    <tr key={record.id}>
                      <td>
                        ...
                        <span className="table-subtext">{record.assignment_id}</span>
                      </td>
                      <td>{record.assignment.order.title}</td>
