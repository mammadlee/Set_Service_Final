...
export const appStrings = {
  ...
  auth: {
    ...
    createAccount: "Yeni müəssisə qeydiyyatı",
    continueRegistration: "Qeydiyyatı davam etdir",
  },

  registration: {
    title: "Müəssisə qeydiyyatı",
    description: "Telefon və e-poçtu təsdiqləyin. Qeydiyyat bundan sonra admin təsdiqinə göndəriləcək.",
    newRegistration: "Yeni qeydiyyat",
    resumeRegistration: "Qeydiyyatı davam etdir",
    companyName: "Müəssisənin adı",
    contactName: "Əlaqədar şəxs",
    phone: "Telefon",
    phoneHelp: "Nömrəni +994501234567 formatında daxil edin.",
    sendPhoneCode: "Telefon kodunu göndər",
    phoneCodeTitle: "Telefonu təsdiqləyin",
    phoneCodeBody: "SMS-lə göndərilən 6 rəqəmli kodu daxil edin.",
    code: "Təsdiq kodu",
    verifyCode: "Kodu təsdiqlə",
    passwordTitle: "Şifrə yaradın",
    passwordBody: "Sonrakı mərhələlərə qayıtmaq üçün bu e-poçt və şifrədən istifadə edəcəksiniz.",
    repeatPassword: "Şifrəni təkrar daxil edin",
    completeRegistration: "Qeydiyyatı tamamla",
    resumeTitle: "Yarımçıq qeydiyyata qayıdın",
    resumeBody: "OTP-dən sonra yaratdığınız e-poçt və şifrə ilə təhlükəsiz qeydiyyat sessiyası açın.",
    emailTitle: "E-poçtu təsdiqləyin",
    emailBody: "E-poçt ünvanınıza göndərilən 6 rəqəmli kodu daxil edin.",
    sendEmailCode: "E-poçt kodunu göndər",
    resendEmailCode: "Kodu yenidən göndər",
    successTitle: "Qeydiyyat tamamlandı",
    successBody: "Telefon və e-poçt təsdiqləndi. Müəssisə indi admin təsdiqini gözləyir; təsdiqdən əvvəl panelə giriş açılmayacaq.",
    backToLogin: "Giriş səhifəsinə keç",
