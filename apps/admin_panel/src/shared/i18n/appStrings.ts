...
export const appStrings = {
  ...
  networkError: 'Şəbəkə bağlantısı alınmadı. Zəhmət olmasa bağlantını və API ünvanını yoxlayın.',
  ...
  auth: {
    ...
    onlySuperAdmin: 'Admin panelə yalnız daxili admin hesabı daxil ola bilər.',
  },
  ...
  dashboard: {
    ...
    pendingWorkers: 'Gözləyən işçilər',
    pendingCompanies: 'Gözləyən şirkətlər',
    assignments: 'Təyinatlar',
    openAttendance: 'Açıq girişlər',
    verifiedTitle: 'Əsas axın təsdiqlənib',
    verifiedBody:
      'Giriş, işçi təsdiqi, şirkət sifarişi, admin təyinatı, işçi qəbulu və QR giriş-çıxış axını təsdiq sınağı ilə yoxlanılıb.',
  },
  ...
  companies: {
    title: 'Şirkət idarəetməsi',
    description: 'Şirkət hesablarını təsdiqləyin və ya rədd edin.',
    search: 'Şirkət axtar',
    empty: 'Cari filtrə uyğun şirkət tapılmadı.',
    detailTitle: 'Şirkət detalları',
    detailDescription: 'Şirkət təsdiqini və sənədləri yoxlayın.',
    name: 'Ad',
    contact: 'Əlaqələndirici',
    phone: 'Telefon',
    email: 'E-poçt',
    status: 'Status',
    docsUrl: 'Sənəd linki',
    ...
    documents: 'Sənədlər',
    noDocuments: 'Sənəd yüklənməyib.',
    approve: 'Şirkəti təsdiqlə',
    reject: 'Şirkəti rədd et',
    approveTitle: 'Şirkət təsdiqlənsin?',
    approveMessage: 'Bu şirkət sifariş yarada biləcək.',
    rejectTitle: 'Şirkət rədd edilsin?',
    rejectMessage: 'Rədd səbəbi mütləqdir.',
  },

  orders: {
    title: 'Sifarişlər',
    description: 'Bütün şirkət sifarişlərini və təyinat saylarını izləyin.',
  ...
  reports: {
    title: 'Hesabatlar',
    description: 'Tarix aralığı, şirkət, işçi və kateqoriya üzrə əməliyyat göstəriciləri.',
    filters: 'Filtrlər',
    ...
    workerWorkCounts: 'İşçi iş sayı',
    companyUsage: 'Şirkət istifadəsi',
  ...
  attendance: {
    ...
    detailDescription: 'Tək giriş-çıxış sessiyasını yoxlayın.',
  ...
  qr: {
    ...
    displayDescription: 'Bu linki public tablet və ya brauzerdə açın. İşçi QR kodu mobil tətbiqdən oxudaraq giriş və ya çıxış edə bilər.',
    assignment: 'Təyinat',
    order: 'Sifariş',
    expires: 'Vaxtı bitir',
  ...
  notifications: {
    ...
    orderCreatedBody: 'Şirkət yeni sifariş yaratdı.',
...
export function statusLabel(status: string): string {
  return (
    {
      draft: 'Qaralama',
      pending_otp: 'Gözləmədə',
      pending_approval: 'Gözləmədə',
      approved: 'Təsdiq olundu',
      rejected: 'Rədd edilib',
      suspended: 'Dayandırılıb',
      inactive: 'Aktiv deyil',
      active: 'Hazırlanır',
      completed: 'Təsdiq olundu',
  ...
  return (
    {
      ...
      RATING_NOT_AVAILABLE: 'Reytinq yalnız checkout tamamlandıqdan sonra verilə bilər.',
      COMPANY_NOT_FOUND: 'Şirkət tapılmadı.',
      ORDER_NOT_FOUND: 'Sifariş tapılmadı.',
      INVALID_WORKER_STATUS: 'İşçi statusu yanlışdır.',
      INVALID_COMPANY_STATUS: 'Şirkət statusu yanlışdır.',
